                                ...
                                <div className="flex flex-col min-w-[360px] h-fit w-[40vw] gap-2 pt-6 pb-6">
                                    <div className="flex flex-row justify-between items-center w-full">
                                        ...
                                        {(item.option === "" ) ?
                                            ...
                                            :
                                            <img className="w-6 h-6" src="/images/icon/checked.svg" alt="icon" onClick={() => selectOpton(item.name, "매장포인트 없음")} />
                                        }
                                    ...
                                    <div className="flex flex-row justify-between items-center w-full">
                                        ...
                                        {/* 오른쪽: 아이콘 */}
                                        {(item.option === "" && item.option !== "매장포인트") ? <img className="w-6 h-6" src="/images/icon/notChecked.svg" alt="icon" onClick={() => selectOpton(item.name, "토스포인트")} /> : <img className="w-6 h-6" src="/images/icon/checked.svg" alt="icon" onClick={() => selectOpton(item.name, "토스포인트 없음")} />}
